...
import { clientReviewHighlights, toggleReviewHighlight } from "../../../../lib/reviewOptions";
...
export default function ReviewClientPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setStatus("success");
    setMessage("Thanks. Your client review has been submitted.");
  ...
  return (
    <main className="container">
      ...
      <section className="pageHeader">
        ...
        <h1>Review the client</h1>
        <p>This helps BookAnInstructor keep the marketplace safe and reliable.</p>
      </section>
